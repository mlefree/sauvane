...
* http://opensource.org/licenses/osl-3.0.html
...
*  @license    http://opensource.org/licenses/osl-3.0.html  Open Software License (OSL 3.0)
...
function setCurrency(id_currency)
{
	$.ajax({
		type: 'POST',
		url: baseDir + 'changecurrency.html',
